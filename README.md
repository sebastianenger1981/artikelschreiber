	...
	<body itemscope itemtype="https://schema.org/WebPage" class="hmedia" style="text-align: left; overflow-wrap: break-word; word-wrap: normal; word-break: break-word;" translate="yes" lang="en">
		...
		<fieldset>
			...
			<ul>
				...
				<li>Server Backend: Improved article generation module (normal and AI based) - now more SEO optimized articles are created</a>
			</ul>	
			<hr>
			<b>Date: 2021-12-27 </b><br />
			Services affected: Backend<br /><br />
			We have implemented these new features:
			<ul>
				<li>Server Backend: Improved Text Generator module</a>
			</ul>	
			<hr>
			<b>Date: 2021-12-26 </b><br />
			Services affected: Backend<br /><br />
			We have implemented these new features:
			<ul>
				<li>Server Backend: Research/Studying Text Generation, Internal programming for release of improvement in Text Generator module</a>
				<li>Server Backend / Frontend: AI module enabled for Chinese language</li>
			</ul>	
			<hr>
			<b>Date: 2021-12-25 </b><br />
			Services affected: Backend<br /><br />
			We have implemented these new features:
			<ul>
				<li>Server Backend: Research/Studying Text Generation, plan to update Text Generator module for better result quality the next days</a>
				<li>Server Backend: Code improvements for better Text Generator module</a>
			</ul>	
			<hr>
			<b>Date: 2021-12-24 </b><br />
			Services affected: Frontend / Backend<br /><br />
			We have implemented these new features:
			<ul>
				<li>Server Backend: Code improvements should result in a few seconds lesser processing time for Article Generator</a>
				<li>Server Frontend: Optimized Templates for Website Frontend Content Generation</a>
				<li>Server Backend: Upgraded our NLP Processing Library for better processing speed and improved text generation quality</a>
				<li>Server Frontend: Advanced Preloading of external ressources implemented to improve rendering speed of website</a>
				<li>Server Frontend: Templates, removed unnessessary Javascript Functions to improve rendering speed of website</a>
				<li>Server Frontend: Templates, all Javascript Functions are now called asynchronically to improve rendering speed of website</a>
				<li>Server Frontend: Added HTML Metakeys to allow caching of webpage to improve rendering & page download speed</a>
			</ul>	
			<hr>
			<b>Date: 2021-12-23 </b><br />
			Services affected: Frontend / Backend<br /><br />
			We have implemented these new features:
			<ul>
				<li>Server Frontend: Switched from jQuery to Vanilla Javascript on Startpage this should reduce load time and decrease page rendering time</a>
				<li>Server Frontend: Removed Ads from Startpages</a>
				<li>Server Frontend: fixed some SEO onpage issues (empty tags, missing description, left out metakeys)</a>
				<li>Server Frontend: fixed API Endpoint: https://www.artikelschreiber.com/api/</a>
				<li>Server Backend: Filtering module improved</li>
				<li>Server Backend: Text Generation module improved</li>
				<li>Server Frontend: Released the blog system for ArtikelSchreiber.com</li>
				<li>Server Frontend: Flags and Links to all 11 different languages on ArtikelSchreiber.com are now removed from template to generate on the fly</li>
				<li>Server Frontend: Integrated Yandex Webmaster Tools (Russian Language Support)</li>
				<li>Server Frontend: Integrated Bing Webmaster Tools (Multi Language Support)</li>
				<li>Server Frontend: Favicon Icon in higher resolution of 120x120 pixels provided to Website for better SEO visibility</li>
			</ul>	
			<hr>
			<b>Date: 2021-12-22 </b><br />
			Services affected: Frontend / Backend<br /><br />
			We have implemented these new features:
			<ul>
				<li>Server Backend / Frontend: Optimized our filtering module</li>
				<li>Server Backend: Optimized Function for improving Text Generation in Article Text output</li>
				<li>Server Backend: Added Function for improving Text Generation</li>
				<li>SEO Optimization: Added structured data from schema.org to created article</li>
				<li>SEO Optimization: Added structured SEO Headlines for each created article so you can copy it</li>
			</ul>	
			<hr>
			<b>Date: 2021-12-21 (Terra: "Awakening Day") </b><br />
	
			Services affected: Frontend / Backend<br /><br />
			We have implemented these new features:
			<ul>
				<li>Server Frontend/Backend: AI Text Generation support for Portuguese, Japan and Arabic language</li>
				<li>Server Frontend: SEO Optimization/Startpage EN,DE: Optimized Footer Keywords</li>
				<li>Server Frontend: SEO Optimization/Onpage: Added more options from The Open Graph protocol (https://ogp.me/) to each webpage</li>
				<li>Server Frontend: SEO Optimization/Onpage: Added a more high resolution image to the Meta Information of each website to enhance quality when sharing the ArtikelSchreiber.com Websites</li>
			</ul>	
			<hr>
			<b>Date: 2021-12-20</b><br />
			Services affected: Frontend / Backend<br /><br />
			We have implemented these new features:
			<ul>
				<li>Server Frontend: New SEO Feature - Created articles will be easily copyable (new Button) and it will add some SEO optimized Schema.org structured data in JSON format which will result in your new article being available as Featured snippet and the Google Knowledge Graph - done: <b>100% / Final release to live Service</b></li>
				<li>Server Frontend: AI based Semantic related topics for your next Article based on your currently created article content - done: <b>100% / Final release to live Service</b></li>
			</ul>	
			<hr>
			<b>Date: 2021-12-19</b><br />
			Services affected: Frontend / Backend<br /><br />
			We have implemented these new features:
			<ul>
				<li>Server Frontend / Backend: Improved our internal stopword lists </li>
				<li>Server Frontend: New SEO Feature - Created articles will be easily copyable (new Button) and it will add some SEO optimized Schema.org structured data in JSON format which will result in your new article being available as Featured snippet, the Knowledge Graph - done: <b>75%</b></li>
				<li>Server Frontend: Improved startpage list elements (flags, links to create articles in other foreign/alien languages)</li> 
				<li>Server Frontend: Improved seo visibility of startpage by optimization of article creation input form fields</li> 
				<li>Server Frontend: Fixed some translations in tool tips for all languages</li> 
				<li>Server Frontend: We have enhanced the HTML code of the free newsletter signup (better language, seo optimized)</li> 
				<li>Server Frontend: We have added the newsletter signup on the start and result page of ArtikelSchreiber.com</li> 
			</ul>	
			<hr>
			<b>Date: 2021-12-18</b><br />
			Services affected: Server Backend, Frontend<br /><br />
			We have implemented these new features:
			<ul>
				<li>Server Frontend: We reduced the timeframe in between the software tries to fetch your created article from the backend databases and reduced wait time till you get to see your article on the Result Website</li>
				<li>Server Backend: Finished implementing AI topic suggestions (100%) - todo: implementing in frontend (est: 2021-12-19)</li>
				<li>Server Backend: Working on software modules based on AI and computural linguistic methods to improve Text Creation</li>
				<li>Server Backend: We continued to work on AI topic suggestions to create another article after your current one (est: 2021-12-19) - done: <b>90%</b></li>
				<li>Server Backend: We published the Backend Server version from 2021-12-18 with version number '6.7.5.5' to live services this night</li>
				<li>Server Backend ('CODE'): 8.855 Lines of Code with over 29.942 individual instructions</br>
				<li>Server Frontend ('CODE'): 9.350 Lines of Code with over 33.369 individual instructions</br>
				<li>Server Frontend ('TEMPLATES'): 20.594 Lines of Code with over 105.568 individual instructions</br>
				<li>Hint: Server Backend improvements positivly affect API, ArtikelSchreiber.com and unaique.net Webservices all together</li>
			</ul>	
			<hr>
			<b>Date: 2021-12-17</b><br />
			Services affected: Server Backend, ArtikelSchreiber.com Frontend<br /><br />
			We have implemented these new features:
			<ul>
				<li>Improvement in Text Creation: We try to create individual texts that fit the language, writing and speaking style of your input words, keywords or sentences</li>
				<li>SEO Optimization: We have removed some links that linked to our website ArtikelSchreiber.com</li>
				<li>French, Spanish, Hindi: for these languages AI module enabled, server will process AI module if processing capacities are available</li>
				<li>French, Spanish, Hindi, Arabic Language moved to new Frontend</li>
				<li>Frontend: All Languages: improved some translations for help texts</li>
				<li>Frontend: All Languages: ArtikelSchreiber.com Texts are now copy & paste friendly: simply click on the texts and the article is copied to your clipboard</li>	<li>Server Backend: Improved Scoring of AI module</li>
				<li>Server Backend: Improved Text Generation module</li>
				<li>Server Backend: Improved String-Matching Functions, Improved Blacklisting Functions</li>
			</ul>	
			<hr>
			<b>Date: 2021-12-16</b><br />
			Services affected: Server Backend, ArtikelSchreiber.com Frontend<br /><br />
			We have implemented these new features:
			<ul>
				<li>API Documentation fresh up: https://www.artikelschreiber.com/api/</li>
				<li>Frontend: improved Loadbalancing</li>
				<li>Server Backend: Improved Scoring of AI module</li>
			</ul>	
			<hr>
			<b>Date: 2021-12-15</b><br />
			Services affected: Server Backend, ArtikelSchreiber.com (german, english language) Frontend<br /><br />
			We have implemented these new features:
			<ul>
				<li>For <b>English Language</b>: unique articles for artikelschreiber.com if server has free capacity to process AI module (Feature Request: "unique articles")</li>
				<li>For <b>German Language</b>: unique articles for artikelschreiber.com if server has free capacity to process AI module (Feature Request: "unique articles")</li>
				<li>For All Languages: We are improving the AI component for unique articles (Feature Request: "unique articles")</li>
				<li>For All Languages with AI Support: Plagarism Check integrated (Feature Request: "uniqueness check")</li>
				<li>Improved Scoring of AI Generation module, Server backend code more stable - processing is doing faster</li>
			</ul>	
			<hr>
			<b>Date: 2021-12-14</b><br />
			Services affected: Server Backend<br /><br />
			We have implemented these new features:
			<ul>
				<li>2021-12-14 9:54pm GMT+1: We are finished with testing the unique articles for English language - production release on 2021-12-15</li>
				<li>2021-12-14 2:12pm GMT+1: We are currently testing the "unaique articles" feature for English language</li>
				<li>Software Improvement for Server Backend: try to create better articles that are grammatically written correctly (Server Backend Version: "14.12.2021") - Feature Request: "better grammar"</li>
				<li>We have worked on the AI components plus a scale that shows how unique an article is (est: December 2021 - "unique article")</li>
				<li>We will release "unique articles" for the English Language of ArtikelSchreiber.com during later this day (based on traffic on Server)</li>
			</ul>	
			<hr>
			<b>Date: 2021-12-13</b><br />
			Services affected: ArtikelSchreiber.com, Unaique.net, Server Backend<br />
			We have implemented these new features during our last update Services affected:
			<ul>
				<li>Software Improvement for Server Backend results in better Article Quality (Server Backend Version: "11.12.2021")</li>
				<li>HTML Improvements for all ArtikelSchreiber.com Language Pages</li>
				<li>www.artikelschreiber.com and www.artikelschreiber.com/en/ new texts for startpage to improve seo visibility</li>
				<li>all Services affected: implemented load balancing features</li>
			</ul>
		</fieldset>
		<br />
		<!--<fieldset lang="en">
			<legend><b>Please link to us from high quality websites:</b></legend>					
			<textarea class="linkme" id="myInput"><a href="https://www.artikelschreiber.com/en/" hreflang="en" title="Article Generator | ArtikelSchreiber.com">Text Generator - Free Text: ArtikelSchreiber.com</a></textarea>
		</fieldset>
		-->
		<section>
			<footer id="footer">
				<p>&copy; 2016 - 2023 - <strong>ArtikelSchreiber.com: ✅ Marketing: Write an article, free text or marketing content with SEO tool for ✅ eCommerce, Business, Sales and Upsell with ✅ Text generator based on ✅ Artificial Intelligence / AI and ✅ Natural Language Processing/NLP</strong></p>
				<br />
				<span>"<cite>Even before I started, I knew I would win!</cite>" by Unknown</span>
				<ul id="footer_ul">
					<li class="footer_ul_li"><a href="https://www.unaique.net/" target="_self" hreflang="de" title="Marketing: Copywriter">KI Text Copywriter</a></li>
					<li class="footer_ul_li">-</li>
					<li class="footer_ul_li"><a href="https://www.unaique.net/en/" target="_self" hreflang="en" title="AI Marketing: CopyWriting">AI Text CopyWriting</a></li>
					<li class="footer_ul_li">-</li>
					<li class="footer_ul_li"><a href="https://www.artikelschreiber.com/" target="_self" hreflang="de" title="Artikel: Schreibe automatisch Marketing Content | ArtikelSchreiber.com">Text schreiben</a></li>
					<li class="footer_ul_li">-</li>
					<li class="footer_ul_li"><a href="https://www.artikelschreiben.com/" target="_self" hreflang="de" title="Artikel schreiben: Für Text, Blog, Vlog schreiben | ArtikelSchreiben.com" >Artikel schreiben</a></li>
					<li class="footer_ul_li"><br /><br /></li>
					<li class="footer_ul_li"><a href="https://www.artikelschreiber.com/en/" target="_self" hreflang="en" title="Article Generator: Write an article for Marketing | ArtikelSchreiber.com">Text Generator</a></li>
					<li class="footer_ul_li">-</li>
					<li class="footer_ul_li"><a href="https://www.unaique.com/" target="_self" hreflang="en" title="AI Content Generator | UNAIQUE.COM">AI Content Generator</a></li>
					<li class="footer_ul_li">-</li>
					<li class="footer_ul_li"><a href="https://www.artikelschreiber.com/en/blog/" target="_self" hreflang="en">Blog</a></li>
					<li class="footer_ul_li">-</li>
					<li class="footer_ul_li"><a href="https://www.artikelschreiber.com/marketing/" target="_self" hreflang="en">Marketing Tools</a></li>
					<br /><br />
					<li class="footer_ul_li"><a href="https://www.unaique.com/impressum.html" target="_self" hreflang="de" title="Impressum" rel="noopener noreferrer nofollow">Impressum</a></li>
					<li class="footer_ul_li">-</li>
					<li class="footer_ul_li"><a href="https://www.unaique.com/privacy-policy.html" target="_self" hreflang="de" title="Datenschutzinformation" rel="noopener noreferrer nofollow">Datenschutz</a></li>
				</ul>										
